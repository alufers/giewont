...
typedef std::map<GoapBlackboardKey, GoapBlackboardValue>
    GoapBlackboard;
...
public:
  ...
  /// @param[out] finish_state_out The state after the action is performed, if it is possible to perform the action
  ...
  /// @param ctx The context of the AI thinking
  /// @return true if the actions should be continued, false if the action is finished
